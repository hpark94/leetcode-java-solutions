...
public class RemoveDuplicatesFromSortedArray {
    ...
    /**
     * An integer array nums sorted in non-decreasing order is given. Removes the duplicates
     * in-place such that each unique element appears only once. Returns the number of unique
     * elements in nums.
     *
     * Time: O(n)
     * Space: O(1)
     ...
     *
     * @return Array with first k unique elements sorted
     */

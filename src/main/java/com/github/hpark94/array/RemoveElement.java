...
public class RemoveElement {
    ...
    /**
     * An integer array nums and an integer val are given. Removes all occurrences of val in nums
     * in-place. Returns the number of elements in nums which are not equal to val.
     *
     * Time: O(n)
     * Space: O(1)
     *
